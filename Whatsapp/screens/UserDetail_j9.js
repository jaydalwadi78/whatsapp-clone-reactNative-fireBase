...
import {
  ...
  //import {photoUploadGallery,photoUploadCamera,showphoto} from '../helper/myhelper';


const UserDetail = (props) => {
    const [modalVisible, setModalVisible] = useState(false);
    console.warn(props.newuserdata.id);
    //console.log('props', props.newuserdata);

    const navigation = useNavigation();
   /*  const images = require('../assets/default.jpg'); */
    const images = 'https://firebasestorage.googleapis.com/v0/b/mydatabase-97162.appspot.com/o/Status%2F150-1503945_transparent-user-png-default-user-image-png-png.png?alt=media&token=41597f01-7e9f-45c0-82ac-3ffb395cee5a';
    ...
    const d = require('../assets/images/default.jpg');
    ...
    // console.log("YYYYYYYYYYYYYY",props.newuserdata.result.mobile_no);
    ...
    const registerHandle = async (data) => {
      ...
      try{
        ...
        .then(data11 => {
            singIn(props.newuserdata.result.mobile_no,props.newuserdata.id,data.profile,data.name);
        })
    }catch(error){
            ...
            <Text style={styles.profile}>
                ...
                <View>
                    <Image
                        style={styles.logo}
                        source={{
                        uri: (image?image:'https://firebasestorage.googleapis.com/v0/b/whatsapp-449b7.appspot.com/o/default.jpg?alt=media&token=5abafef2-b20a-4d23-8c9d-8419310aa8ae')
                        }}
                    />
                </View>
        </View>
