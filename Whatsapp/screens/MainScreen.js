...
function MainScreen(props) {
  ...
  return (
    <Tab.Navigator initialRouteName="Chats"
      ...
      <Tab.Screen name='Chats'  component={MessageScreen} initialParams={{ 'userDetails': userDetails }} />
      <Tab.Screen name='Call' component={CallScreen} options={{ title: 'Call' }} />
      <Tab.Screen name='Status' component={StatusScreen} styles={{backgroundColor:LIGHT_GREEN}}/>     
    </Tab.Navigator>
  )
}
